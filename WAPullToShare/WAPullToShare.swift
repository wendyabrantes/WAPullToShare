...
class WAContainerView : UIView {
    ...
    var changeIndexCompletion:((UIButton, WAPullToShareButtonType) -> Void)?
    ...
    override func animationDidStop(anim: CAAnimation, finished flag: Bool) {
        ...
        if flag {
                self.changeIndexCompletion!( self.items[0], WAPullToShareButtonType.facebook)
...
public class WAPullToShareScrollView : UIScrollView, UIScrollViewDelegate {
    ...
    func setupLayout(){
        ...
        containerView.changeIndexCompletion = { (button, buttonType) -> Void in
